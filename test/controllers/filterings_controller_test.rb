...
class FilteringsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filtering" do
    assert_difference('Filtering.count') do
      post filterings_url, params: { filtering: { degree: @filtering.degree, price: @filtering.price, sUserID: @filtering.sUserID, servicdProvider: @filtering.servicdProvider } }
    end
  ...
  test "should update filtering" do
    patch filtering_url(@filtering), params: { filtering: { degree: @filtering.degree, price: @filtering.price, sUserID: @filtering.sUserID, servicdProvider: @filtering.servicdProvider } }
